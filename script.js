...
/* =========================================================================
   ...
   .cover-spacer, we fade into the notebook underneath.
   ========================================================================= */
(function heroFade() {
...
/* =========================================================================
   ...
   with how many posts exist in the notebook's table of contents (dim returns)
   ========================================================================= */
(function initStarscape() {
	...
	for (let i = 0; i < starCount; i++) {
	    ...
	    // three size classes, most stars small
...
let pyodideReady = null; // set on first python run
